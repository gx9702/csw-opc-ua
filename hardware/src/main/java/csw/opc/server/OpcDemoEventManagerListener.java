 ...
 */
public class OpcDemoEventManagerListener implements EventManagerListener {

    private static Logger log = Logger.getLogger(OpcDemoEventManagerListener.class);
    ...
    public boolean onAcknowledge(ServiceContext serviceContext,
        ...
        log.info("Acknowledge: Condition=" + condition + "; EventId="
    ...
    public boolean onAddComment(ServiceContext serviceContext,
        ...
        log.info("AddComment: Condition=" + condition + "; Event="
                + eventIdToString(eventId) + "; Comment=" + comment);
    ...
    public boolean onConfirm(ServiceContext serviceContext,
        ...
        log.info("Confirm: Condition=" + condition + "; EventId="
                + eventIdToString(eventId) + "; Comment=" + comment);
    ...
    public boolean onDisable(ServiceContext serviceContext,
        ...
        log.info("Disable: Condition=" + condition);
    ...
    public boolean onEnable(ServiceContext serviceContext,
        ...
        log.info("Enable: Condition=" + condition);
        if (!condition.isEnabled()) {
            DateTime now = DateTime.currentTime();
