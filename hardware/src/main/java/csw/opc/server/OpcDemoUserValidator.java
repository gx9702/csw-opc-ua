 ...
 */
public class OpcDemoUserValidator implements UserValidator {

	private static Logger logger = Logger.getLogger(OpcDemoUserValidator.class);
	...
	public boolean onValidate(Session session, ServerUserIdentity userIdentity)
        ...
        if (userIdentity.getType().equals(UserTokenType.UserName))
            return userIdentity.getName().equals("opcua") && userIdentity.getPassword().equals("opcua")
                    || userIdentity.getName().equals("opcua2") && userIdentity.getPassword().equals("opcua2");
