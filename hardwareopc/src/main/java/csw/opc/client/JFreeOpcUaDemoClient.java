 ...
 */
public class JFreeOpcUaDemoClient {
...
//    };
    ...
    public JFreeOpcUaDemoClient(String host, Listener listener)
...
//        int ns = 2; // XXX above doesn't work in freeopcua
        int ns = 2; // XXX above doesn't work in freeopcua
    ...
    private void write(NodeId nodeId, String value)
        ...
        try {
            ...
            if (status)
                ...
                log.info("OK (completes asynchronously)");
        } catch (ServiceException | StatusException e) {
            printException(e);
        }
    }
